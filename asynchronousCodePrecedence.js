 ...
 * The numbers show of the code execution order
   
 */

const promiseWithTimer = () => {
  console.log("4. Body of second promise started");
  return new Promise((resolve) => {
    setTimeout(() => {
      resolve("Last. Resolve from second result");
    }, 1000);
  });
};
...
const promiseWithoutTimer = () => {
  return new Promise((resolve) => {
    resolve("5. Resolved from promiseWithoutTimer");
  });
};
...
console.log("2. From Main Thread Before using the promises");
